  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${
        isScrolled
          ? "bg-white/85 dark:bg-[#08090d]/85 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800/80 py-3.5 shadow-sm shadow-zinc-950/5 dark:shadow-black/20"
          : "bg-transparent py-5"
      }`}
    >
